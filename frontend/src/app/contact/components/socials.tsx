export default function Socials() {
    return (
        <section className="max-w-2xl mx-auto px-6 py-20 text-center">
            <h1 className="mb-4">Follow me</h1>

            <div className="flex justify-center items-center gap-4 flex-wrap">
                <a
                    href="https://github.com/Tonii18"
                    target="_blank"
                ...
                <a
                    href="https://linkedin.com/in/antonio-jesús-sánchez-rosales-794957255"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <a
                    href="https://instagram.com/antoniiosanchezz_"
                    target="_blank"
                    rel="noopener noreferrer"
